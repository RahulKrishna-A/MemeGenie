...
export default function Meme() {
    ...
    return (
        ...
        <div id={"meme_container"}>
            <div>
                <div>
                    <input onChange={handleChange} value={meme.topText} name={"topText"} type={"text"} id={"Field-1"}
                           placeholder={"Top text"}/>
                    <input onChange={handleChange} value={meme.bottomText} name={"bottomText"} type={"text"}
                           id={"Field-2"} placeholder={"Bottom text"}/>
                </div>
